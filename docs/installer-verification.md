...
1. Leave **Start DisplayPilot when I sign in** selected in the installer.
...
4. Confirm that the application directory, Start menu shortcut, and this
   account's DisplayPilot startup entry are removed.
